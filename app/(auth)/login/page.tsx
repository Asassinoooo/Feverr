  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-800">Masuk ke Feverr</h1>
          <p className="text-sm text-slate-500 mt-1">Belum punya akun?{' '}
            <Link href="/register" className="text-[#3b5fa0] hover:underline">Daftar</Link>
          </p>
        </div>

        {/* Quick login hint */}
        <div className="bg-[#f1f5f9] border border-slate-200 p-3 mb-6 text-xs text-slate-500">
          <p className="font-medium text-slate-600 mb-1">Akun demo:</p>
